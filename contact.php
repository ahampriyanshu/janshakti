...
<html>
  ...
  <body background="#f3f7f7">
    ...
    echo "<div id=\"abt\" style=\"position: absolute; top:12%;left:20%;\">
      ...
      <div  style='position: absolute; top:15%; left:30%;' id='contact_show'>Member1 Github<div id='contact_hide'>&emsp;visit GNDEC official website&emsp;</div></div>
      <div  style='position: absolute; top:38%; right:30%;' id='contact_show'>Member2 Github<div id='contact_hide'>&emsp;Download zip file</div></div>
      <div  style='position: absolute; top:62%; left:33%;' id='contact_show'>Member3 Github<div id='contact_hide'>&emsp;&emsp;fork this website's repository &emsp;&emsp;</div></div>
